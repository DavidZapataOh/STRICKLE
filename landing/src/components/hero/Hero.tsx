  ...
  return (
    <section className="bg-ground text-ink">
      <HeroScene className="flex min-h-[100svh] flex-col">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1320px] flex-1 flex-col justify-center px-[clamp(24px,4vw,72px)] pb-[14vh] pt-6 max-md:justify-start max-md:px-[22px] max-md:pb-6 max-md:pt-8">
          <div className="max-w-[640px]">
            <h1 className="reveal reveal-delay-1 font-display text-[clamp(38px,10vw,54px)] font-extrabold leading-[0.98] tracking-[-0.015em] text-ink md:text-[clamp(40px,4vw,58px)]">
              Prove the threshold.
              <br />
        ...
        <footer className="relative z-10 mx-auto flex min-h-14 w-full max-w-[1320px] flex-wrap items-center justify-between gap-x-6 gap-y-2 px-[clamp(24px,4vw,72px)] py-3 font-body text-[12.5px] text-ink-muted tabular-nums max-md:px-[22px]">
