  ...
  return (
    <section className="bg-ground text-ink">
      <HeroScene className="flex min-h-[100svh] flex-col">
        ...
        <footer className="relative z-10 flex min-h-14 flex-wrap items-center justify-between gap-x-6 gap-y-2 px-[clamp(24px,4vw,64px)] py-3 font-body text-[12.5px] text-ink-muted tabular-nums max-md:px-[22px]">
