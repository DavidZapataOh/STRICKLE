      ...
      <div className="phone w-[min(100%,280px)]">
        <div className="phone-screen">
          <div className="flex items-center gap-2 bg-[var(--steel-900)] px-4 py-3 text-[var(--steel-50)]">
            ...
            <span className="font-display text-micro font-extrabold uppercase tracking-[0.06em]">STRICKLE</span>
          </div>
          <div className="px-4 pb-4 pt-4">
            ...
            <div className="mt-3 rounded-[6px] px-3 py-2.5 text-[var(--verdict)]" style={{ boxShadow: "inset 0 0 0 1px currentColor, inset 2px 3px 6px rgba(0,0,0,0.12)", background: "rgba(27,107,68,0.06)" }}>
              <div className="flex items-center gap-2">
                ...
                <span className="font-display text-subtitle font-bold leading-none">{c.verdict}</span>
              </div>
            ...
            <p className="mt-4 text-center font-body text-micro uppercase tracking-[0.08em] text-steel-600">{c.footer}</p>
          </div>
        </div>
      </div>
    </div>
