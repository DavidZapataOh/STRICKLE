...
| `npm run compile -w @strickle/cli` | The same compile, invoked by `setup.ts` and named in three of its error messages. Not a duplicate: deleting it breaks `npm run setup`. |
